...
@register_connector
class VirusTotalConnector(SimpleConnector):
    """VirusTotal intelligence."""
    ...
    default_source: ClassVar[str] = "virustotal"
    opsec_profile_name: ClassVar[str] = "default"

    def _demo_samples(self) -> list[dict[str, Any]]:
        return [
            {
                "title": "[virustotal] VirusTotal intelligence",
                "description": (
                    "VirusTotal intelligence. Sample IOCs for pipeline validation: "
                    "user@corp-demo.com 198.51.100.42 malware.example "
                    "CVE-2024-12345 wallet 1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa"
                ),
                "url": "https://example.local/virustotal/item/1",
                "author": "virustotal-collector",
                "tags": ["threat_intel", "virustotal", "demo"],
                "category": "ioc",
                "severity": "medium",
            }
        ]
