...
@register_connector
class GreyNoiseConnector(SimpleConnector):
    """GreyNoise IP reputation."""
    ...
    default_source: ClassVar[str] = "greynoise"
    opsec_profile_name: ClassVar[str] = "default"

    def _demo_samples(self) -> list[dict[str, Any]]:
        return [
            {
                "title": "[greynoise] GreyNoise IP reputation",
                "description": (
                    "GreyNoise IP reputation. Sample IOCs for pipeline validation: "
                    "user@corp-demo.com 198.51.100.42 malware.example "
                    "CVE-2024-12345 wallet 1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa"
                ),
                "url": "https://example.local/greynoise/item/1",
                "author": "greynoise-collector",
                "tags": ["threat_intel", "greynoise", "demo"],
