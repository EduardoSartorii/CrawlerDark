...
@register_connector
class ShodanConnector(SimpleConnector):
    """Shodan internet-facing asset discovery."""
    ...
    default_source: ClassVar[str] = "shodan"
    opsec_profile_name: ClassVar[str] = "default"

    def _demo_samples(self) -> list[dict[str, Any]]:
        return [
            {
                "title": "[shodan] Shodan internet-facing asset discovery",
                "description": (
                    "Shodan internet-facing asset discovery. Sample IOCs for pipeline validation: "
                    "user@corp-demo.com 198.51.100.42 malware.example "
                    "CVE-2024-12345 wallet 1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa"
                ),
                "url": "https://example.local/shodan/item/1",
                "author": "shodan-collector",
                "tags": ["threat_intel", "shodan", "demo"],
