...
@register_connector
class DiscordConnector(SimpleConnector):
    """Discord server monitoring."""
    ...
    default_source: ClassVar[str] = "discord"
    opsec_profile_name: ClassVar[str] = "social"

    def _demo_samples(self) -> list[dict[str, Any]]:
        return [
            {
                "title": "[discord] Discord server monitoring",
                "description": (
                    "Discord server monitoring. Sample IOCs for pipeline validation: "
                    "user@corp-demo.com 198.51.100.42 malware.example "
                    "CVE-2024-12345 wallet 1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa"
                ),
                "url": "https://example.local/discord/item/1",
                "author": "discord-collector",
                "tags": ["social", "discord", "demo"],
                "category": "osint",
                "severity": "medium",
            }
        ]
