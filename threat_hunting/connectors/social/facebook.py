...
@register_connector
class FacebookConnector(SimpleConnector):
    """Facebook OSINT collection."""
    ...
    default_source: ClassVar[str] = "facebook"
    opsec_profile_name: ClassVar[str] = "social"

    def _demo_samples(self) -> list[dict[str, Any]]:
        return [
            {
                "title": "[facebook] Facebook OSINT collection",
                "description": (
                    "Facebook OSINT collection. Sample IOCs for pipeline validation: "
                    "user@corp-demo.com 198.51.100.42 malware.example "
                    "CVE-2024-12345 wallet 1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa"
                ),
                "url": "https://example.local/facebook/item/1",
                "author": "facebook-collector",
                "tags": ["social", "facebook", "demo"],
                "category": "osint",
                "severity": "medium",
            }
        ]
