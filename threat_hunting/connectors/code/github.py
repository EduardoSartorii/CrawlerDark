...
Responsibility
--------------
GitHub code search for secrets, credentials and IOCs
...
@register_connector
class GitHubConnector(SimpleConnector):
    """GitHub code search for secrets, credentials and IOCs."""

    name: ClassVar[str] = "github"
    category_group: ClassVar[str] = "code"
    default_category: ClassVar[FindingCategory] = FindingCategory.OSINT
    default_source: ClassVar[str] = "github"
    opsec_profile_name: ClassVar[str] = "default"

    def _demo_samples(self) -> list[dict[str, Any]]:
        return [
            {
                "title": "[github] GitHub code search for secrets, credentials and IOCs",
                "description": (
                    "GitHub code search for secrets, credentials and IOCs. Sample IOCs for pipeline validation: "
                    "user@corp-demo.com 198.51.100.42 malware.example "
                    "CVE-2024-12345 wallet 1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa"
                ),
                "url": "https://example.local/github/item/1",
                "author": "github-collector",
                "tags": ["code", "github", "demo"],
                "category": "osint",
                "severity": "medium",
            }
        ]
