...
@register_connector
class MarketplacesConnector(SimpleConnector):
    """Dark web marketplace monitoring."""

    name: ClassVar[str] = "marketplaces"
    category_group: ClassVar[str] = "darkweb"
    default_category: ClassVar[FindingCategory] = FindingCategory.DARK_WEB
    default_source: ClassVar[str] = "marketplaces"
    opsec_profile_name: ClassVar[str] = "darkweb"

    def _demo_samples(self) -> list[dict[str, Any]]:
        return [
            {
                "title": "[marketplaces] Dark web marketplace monitoring",
                "description": (
                    "Dark web marketplace monitoring. Sample IOCs for pipeline validation: "
                    "user@corp-demo.com 198.51.100.42 malware.example "
                    "CVE-2024-12345 wallet 1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa"
                ),
                "url": "https://example.local/marketplaces/item/1",
                "author": "marketplaces-collector",
                "tags": ["darkweb", "marketplaces", "demo"],
                "category": "dark_web",
                "severity": "medium",
            }
        ]
